...
from core.variables.segments import ArraySegment, StringSegment
...
from core.workflow.nodes.event.event import RunCompletedEvent, RunRetrieverResourceEvent
from core.workflow.nodes.llm.exc import InvalidContextStructureError
...
class AgentNode(ToolNode):
    ...
    def _fetch_context(self, node_data: AgentNodeData):
        ...
        *,
        ...
        for parameter_name in node_data.agent_parameters:
            ...
            if agent_input.type == "variable":
                ...
                if isinstance(parameter_value, str) and context:
                    parameter_value = parameter_value.replace("{{#context#}}", context)
            else:
